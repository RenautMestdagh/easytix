...
class OrganizationMediaRequest extends FormRequest
{
    ...
    {
        return [
            'logo' => 'nullable|image|max:2048|mimes:jpg,jpeg,png,webp|dimensions:max_width=5000,max_height=5000',  //2000x2000
            'background' => 'nullable|image|max:5120|mimes:jpg,jpeg,png,webp|dimensions:max_width=5000,max_height=5000', //3000x1500
            'favicon' => 'nullable|image|max:1024|mimes:png,ico|dimensions:max_width=5000,max_height=5000',
        ];
    }
