<div class="py-16">
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-10">
            ...
            <a href="{{ route('users.index') }}" class="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 flex items-center transition-all duration-300 ease-in-out">
                            ...
                            <div class="flex flex-col">
                                ...
                                <x-ui.forms.group label="Organization" for="organization_id" error="organization_id">
                                    <x-ui.forms.select
                                        ...
                                        class="rounded-xl shadow-md focus:ring-2 focus:ring-indigo-500"
                                        :disabled="$adminCount <= 1 && $user->hasRole('admin')"
                                    >
