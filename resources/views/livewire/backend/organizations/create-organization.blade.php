<div class="py-16">
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-10">
            ...
            <a href="{{ route('organizations.index') }}" wire:navigate class="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 flex items-center transition-colors duration-300 ease-in-out">
