                                ...
                                <div>
                                    ...
                                    @if($header_image)
                                        <div class="flex items-center gap-4 mt-4">
                                            ...
                                            <x-ui.cross-button wire:click="$set('header_image', null)" />
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div>
                                    ...
                                    @if($background_image)
                                        <div class="flex items-center gap-4 mt-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-medium text-gray-900 dark:text-gray-200 truncate">
                                                    {{ $background_image->getClientOriginalName() }}
                                                </p>
                                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                                    {{ round($background_image->getSize() / 1024, 2) }} KB
                                                </p>
                                            </div>
                                            <x-ui.cross-button wire:click="$set('background_image', null)" />
                                        </div>
                                    @endif
                                </div>
                            </div>
