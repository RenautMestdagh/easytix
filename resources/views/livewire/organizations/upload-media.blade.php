                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <label for="favicon-upload" class="cursor-pointer">
                                        <div class="border-2 border-dashed @error('favicon') border-red-500 @else border-gray-300 dark:border-gray-600 @enderror rounded-lg p-4 text-center hover:border-blue-500 transition duration-200">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <label for="logo-upload" class="cursor-pointer">
                                        <div class="border-2 border-dashed @error('logo') border-red-500 @else border-gray-300 dark:border-gray-600 @enderror rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                                            </svg>
                                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <label for="background-upload" class="cursor-pointer">
                                        <div class="border-2 border-dashed @error('background') border-red-500 @else border-gray-300 dark:border-gray-600 @enderror rounded-lg p-4 text-center hover:border-purple-500 transition duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                                            </svg>
                                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
