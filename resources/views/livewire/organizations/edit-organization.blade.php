                                ...
                                <div class="overflow-hidden shadow-sm sm:rounded-lg bg-white dark:bg-gray-800 mx-8">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700" wire:click="sortUsersBy('role')">
                                                {{ __('Role') }}
                                                ...
                                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                                    <div class="flex justify-end gap-2">
                                                        ...
                                                        @else
                                                            ...
                                                            <!-- Soft Delete Button - Only show if not the only admin -->
                                                            @if (!($user->role === 'admin' && $adminCount <= 1))
                                                                <button type="button"
                                                                        onclick="confirmUserSoftDelete({{ $user->id }}, '{{ addslashes($user->name) }}')"
