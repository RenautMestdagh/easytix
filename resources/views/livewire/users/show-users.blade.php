                                                    ...
                                                    @else
                                                        @role('superadmin')
                                                            @php
                                                                ...
                                                                $isLoginDisabled = $isOwnUser || $isSuperadmin;
                                                            @endphp
                                                            <button type="button"
                                                                    ...
                                                                    class="p-1 rounded-full transition-colors
                                                                        ...
                                                                        @else
                                                                            text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-gray-100 dark:hover:bg-gray-700
                                                                        @endif"
                                                                    @if($isLoginDisabled) disabled @endif
                                                                    title="{{ $isSuperadmin ? __('Cannot login as superadmin') : ($isOwnUser ? __('Cannot login as yourself') : __('Log in')) }}">
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
