<div class="flex items-center justify-center p-4">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full">
            ...
            <div id="payment-element" class="rounded-md mb-4"></div>
    ...
    <script>
        if('{{$this->timeRemaining}}' !== 'EXPIRED') {
            ...
            function handleError(submitError) {
                ...
                timer = setInterval(() => updateTimeRemaining(expiresAt), 1000);
            }
            ...
            submitBtn.addEventListener('click', async (event) => {
                ...
                const result = await stripe.confirmPayment({
                    ...
                    clientSecret,
                    confirmParams: {
                        return_url: 'https://{{$this->event->organization->subdomain . '.' . config('app.domain')}}/stripe/callback',
                    },
                });
                console.log(result);
