...
<div>
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between gap-4 flex-wrap justify-center">
                <div class="flex-1">
                    <p class="text-sm text-gray-700 leading-5 dark:text-gray-400 flex flex-nowrap gap-1">
                ...
                <div class="flex-1 ms-0 sm:-ms-12 md:ms-0">
                ...
                <div class="flex items-center gap-2 flex-nowrap justify-end flex-1">
                    <span class="text-sm text-gray-700 dark:text-gray-300 text-nowrap">{{ __('Items per page:') }}</span>
                    <select wire:model.live="perPage" class="border rounded-lg p-2 text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300">
                        <option value="5">5</option>
                        <option value="10">10</option>
                        <option value="25">25</option>
